...
base_paths <- list(
  SNV = "{directory to snv rtg folder}",
  Indel = "{directory to indel rtg folder}",
  SV = "{directory to sv rtg folder}"
)
...
# Save
ggsave("4A_vaf_precision_sensitivity_plot.svg", final_combined_plot, width = 12, height = 10)
...
# Save
ggsave("4B_kmer_precision_sensitivity_plot.svg", final_combined_plot, width = 12, height = 10)
...
# Save
ggsave("4C_caller_by_MEI.svg", final_combined_plot, width = 5,height = 6.038, units = "in")
...
# Save
ggsave("4D_composition_in_mappability.svg", plot, width = 8,height = 9.74, units = "in")
